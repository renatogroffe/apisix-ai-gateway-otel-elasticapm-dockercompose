...
Deixo aqui meus agradecimentos ao Daniel Dias de Assumpção (@dassump) pela colaboração com o script para testes com o Elastic: **https://github.com/dassump/docker-elastic-stack**
